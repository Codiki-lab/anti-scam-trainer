...
Перед публикацией изменения схемы проверяется последовательность `up/down/up` как на чистой БД, так и на схеме версии 5 с существующими Пользователем, Сценарием и Прогрессом. Ожидаемые seed-количества после `up`: 12 Тем, 60 блоков Теории, 60 вопросов Quiz, 240 вариантов Quiz и 48 опубликованных Сценариев.
