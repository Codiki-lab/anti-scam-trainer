...
- Перед началом реализации каждой спецификации создавайте отдельную ветку от актуальной базовой ветки. Имя ветки должно отражать работу по спецификации; включайте номер Issue и краткое описание, например `11-architecture-refactor`.
